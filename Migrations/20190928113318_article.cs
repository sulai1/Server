    ...
    public partial class article : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Slots", x => new { x.ArticleId, x.SlotTypeId });
                    table.ForeignKey(
                        name: "FK_Slots_Articles_ArticleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SlotArticleId = table.Column<int>(nullable: true),
                    SlotTypeId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        columns: x => new { x.SlotArticleId, x.SlotTypeId },
